              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form @submit.prevent="SubmitForm">
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <span class="h1 fw-bold mb-0">Kwanma.brew | Register</span>
                  </div>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Have an account? <router-link to="/login"
        ...
        <div class="col-md-3">
            ...
            <form @submit.prevent="SubmitForm">
                <div class="from-group mb-3">
                    ...
                    <input id="username" type="text" class="form-control" placeholder="Username" v-model="user.username" required>
                </div>
                <div class="from-group mb-3">
...
export default {
    ...
    methods:{
        SubmitForm(){
            axios.post('http://localhost:4000/api-user/create-user', this.user)
            .then(() => {
    ...
    created() {
    document.title = "Kwanma.brew | Sign Up";
    //user in logged        
